...
public final class Auth {
    ...
    private static void copyPolicy(final Map policy, StringMap originPolicy, final boolean strict) {
        ...
        originPolicy.forEach(new StringMap.Consumer() {
            ...
            public void accept(String key, Object value) {
                ...
                if (!strict || StringUtils.isNullOrEmpty(key)) {
    ...
    public String uploadTokenWithDeadline(String bucket, String key, long deadline, StringMap policy, boolean strict) {
        ...
        String s = Json.encodeMap(x);
        return signWithData(StringUtils.utf8Bytes(s));
    }

    public String uploadTokenWithPolicy(Map<String,Object> obj) {
        String s = Json.encodeMap(obj);
        return signWithData(StringUtils.utf8Bytes(s));
    }
